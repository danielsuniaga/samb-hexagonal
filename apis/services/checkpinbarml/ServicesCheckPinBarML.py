...
class ServicesCheckPinBarML:
    def set_project_name(self, project_name):
        return self.ServicesMethodologyPinBarML.set_project_name(project_name)

    def get_project_name(self):
        return self.ServicesMethodologyPinBarML.get_project_name()
    # --- Servicios base de CheckPinBar ---
    ServicesDeriv = None
    ...
    # --- Servicios ML (heredados de WMAML) ---
    ServicesModels = None
    ...
    def init_services_methodology_pinbar_ml(self, value):
        self.ServicesMethodologyPinBarML = value
        return True
    ...
    def get_id_methodology(self):
        return self.ServicesMethodologyPinBarML.get_id()
    ...
    def check_candles(self, candles):
        return self.ServicesMethodologyPinBarML.check_candles(candles)
    ...
    def check_rsi(self, rsi):
        return self.ServicesMethodologyPinBarML.check_rsi(rsi)

    def check_sma(self, sma, last_candle):
        return self.ServicesMethodologyPinBarML.check_sma(sma, last_candle)
    ...
    def add_result_indicators(self, result_indicators):
        return self.ServicesMethodologyPinBarML.add_indicator(result_indicators)

    def check_result_indicators(self, result_indicators):
        return self.ServicesMethodologyPinBarML.check_result_indicators(result_indicators)
    ...
    def check_monetary_filter_services(self, result):
        return self.ServicesMethodologyPinBarML.check_monetary_filters(result)
    ...
    def get_type_entry(self):
        return self.ServicesMethodologyPinBarML.get_type_entry_positions()
    ...
    def set_candles_positions(self, candles):
        return self.ServicesMethodologyPinBarML.set_result_candles(candles)
    ...
    def get_candle_removed(self):
        return self.ServicesMethodologyPinBarML.get_candle_removed()
    ...
    def get_condition_entry(self):
        return self.ServicesMethodologyPinBarML.get_condition_entry()
    ...
    def set_result_positions_entity(self, result):
        return self.ServicesMethodologyPinBarML.set_result_entrys(result)

    def add_entrys(self, result):
        return self.ServicesEntrys.add_entrys(result)

    def get_indicators(self):
        return self.ServicesMethodologyPinBarML.get_indicators()
    ...
    def get_result_entrys_result(self):
        return self.ServicesMethodologyPinBarML.get_result_entrys_result()
    ...
    def get_name_methodology(self):
        return self.ServicesMethodologyPinBarML.get_name()
    ...
    # --- Métodos ML (heredados de ServicesCheckWMAML) ---
    ...
    # --- Método principal loops (combinando PinBar + ML) ---
    async def loops(self):
        logger = logging.getLogger('apis.services.checkpinbarml')
        execution_id = str(uuid.uuid4())[:8]
        methodology = self.get_name_methodology()
        project_name = self.get_project_name() or 'PinBarML'
        ...
        logger.info(f"🎯 LOOPS EXECUTION | Execution: {execution_id} | Project: {project_name} | Method: loops | Methodology: {methodology} | Step: 6. Integración ML - verificando modelos predictivos")
        result = self.check_predict_models(result, result_candles)
        logger.info(f"🎯 LOOPS EXECUTION | Execution: {execution_id} | Project: {project_name} | Method: loops | Methodology: {methodology} | Step: 6.1. ML check_predict_models | Valid: {bool(result)}")
