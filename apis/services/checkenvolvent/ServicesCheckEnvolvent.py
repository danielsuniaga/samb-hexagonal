...
class ServicesCheckEnvolvent:
    ...
    def get_project_name(self):
        return self.ServicesMethodologyEnvolvent.get_project_name()

    def get_name_methodology(self):
        return self.ServicesMethodologyEnvolvent.get_name()
    ...
    def init_services_methodology_envolvent(self, value):
        self.ServicesMethodologyEnvolvent = value
        return True
    ...
    def get_id_methodology(self):
        return self.ServicesMethodologyEnvolvent.get_id()
    ...
    def check_candles(self, candles):
        return self.ServicesMethodologyEnvolvent.check_candles(candles)
    ...
    def check_rsi(self, rsi):
        return self.ServicesMethodologyEnvolvent.check_rsi(rsi)

    def check_sma(self, sma, last_candle):
        return self.ServicesMethodologyEnvolvent.check_sma(sma, last_candle)
    ...
    def add_result_indicators(self, result_indicators):
        return self.ServicesMethodologyEnvolvent.add_indicator(result_indicators)

    def check_result_indicators(self, result_indicators):
        return self.ServicesMethodologyEnvolvent.check_result_indicators(result_indicators)
    ...
    def check_monetary_filter_services(self, result):
        return self.ServicesMethodologyEnvolvent.check_monetary_filters(result)
    ...
    def get_type_entry(self):
        return self.ServicesMethodologyEnvolvent.get_type_entry_positions()
    ...
    def set_candles_positions(self, candles):
        return self.ServicesMethodologyEnvolvent.set_result_candles(candles)
    ...
    def get_candle_removed(self):
        return self.ServicesMethodologyEnvolvent.get_candle_removed()
    ...
    def get_condition_entry(self):
        return self.ServicesMethodologyEnvolvent.get_condition_entry()
    ...
    def set_result_positions_entity(self, result):
        return self.ServicesMethodologyEnvolvent.set_result_entrys(result)
    ...
    def get_indicators(self):
        return self.ServicesMethodologyEnvolvent.get_indicators()
    ...
    def get_result_entrys_result(self):
        return self.ServicesMethodologyEnvolvent.get_result_entrys_result()
