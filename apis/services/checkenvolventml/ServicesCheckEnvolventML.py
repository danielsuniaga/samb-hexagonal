class ServicesCheckEnvolventML:
    # --- Servicios base de CheckEnvolvent ---
    ServicesDeriv = None
    ...
    def init_services_methodology_envolvent_ml(self, value):
        self.ServicesMethodologyEnvolventML = value
        return True
    ...
    def get_id_methodology(self):
        return self.ServicesMethodologyEnvolventML.get_id()
    ...
    def check_candles(self, candles):
        return self.ServicesMethodologyEnvolventML.check_candles(candles)
    ...
    def check_rsi(self, rsi):
        return self.ServicesMethodologyEnvolventML.check_rsi(rsi)

    def check_sma(self, sma, last_candle):
        return self.ServicesMethodologyEnvolventML.check_sma(sma, last_candle)
    ...
    def add_result_indicators(self, result_indicators):
        return self.ServicesMethodologyEnvolventML.add_indicator(result_indicators)

    def check_result_indicators(self, result_indicators):
        return self.ServicesMethodologyEnvolventML.check_result_indicators(result_indicators)
    ...
    def check_monetary_filter_services(self, result):
        return self.ServicesMethodologyEnvolventML.check_monetary_filters(result)
    ...
    def get_type_entry(self):
        return self.ServicesMethodologyEnvolventML.get_type_entry_positions()
    ...
    def set_candles_positions(self, candles):
        return self.ServicesMethodologyEnvolventML.set_result_candles(candles)
    ...
    def get_candle_removed(self):
        return self.ServicesMethodologyEnvolventML.get_candle_removed()
    ...
    def get_condition_entry(self):
        return self.ServicesMethodologyEnvolventML.get_condition_entry()
    ...
    def set_result_positions_entity(self, result):
        return self.ServicesMethodologyEnvolventML.set_result_entrys(result)

    def add_entrys(self, result):
        return self.ServicesEntrys.add_entrys(result)

    def get_indicators(self):
        return self.ServicesMethodologyEnvolventML.get_indicators()
    ...
    def get_result_entrys_result(self):
        return self.ServicesMethodologyEnvolventML.get_result_entrys_result()
    ...
    def get_name_methodology(self):
        return self.ServicesMethodologyEnvolventML.get_name()
    ...
    async def loops(self):
        ...
        # Integración ML - verificación de modelos predictivos específica para Envolvent
