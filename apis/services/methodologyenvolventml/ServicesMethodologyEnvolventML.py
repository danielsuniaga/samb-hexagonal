import apis.entities.methodologyenvolventml.EntityMethodologyEnvolventML as EntityMethodologyEnvolventML

class ServicesMethodologyEnvolventML:

    entity = None

    def __init__(self):
        self.entity = EntityMethodologyEnvolventML.EntityMethodologyEnvolventML()
        self.entity.init_config()

    # --- Métodos base heredados de ServicesMethodologyEnvolvent ---
    def get_id(self):
    ...
    def check_sma(self, sma, last_candle):
        return self.entity.get_metrics_sma_active() and self.entity.check_sma(sma, last_candle)
    ...
    # --- Métodos ML adicionales heredados de ServicesMethodologyTrendsExpansiveML ---
