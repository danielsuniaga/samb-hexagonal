...
class ServicesCheckTrendsExpansiveRecentML:
    # --- Servicios base de CheckTrendsExpansiveRecent ---
    ServicesDeriv = None
    ...
    def get_project_name(self):
        return self.ServicesMethodologyTrendsExpansiveRecentML.get_project_name()

    def get_name_methodology(self):
        return self.ServicesMethodologyTrendsExpansiveRecentML.get_name()
    ...
    def init_services_methodology_trends_expansive_recent_ml(self,value):
        self.ServicesMethodologyTrendsExpansiveRecentML = value
        return True
    ...
    # --- Métodos base de operación ---
    async def init(self):
        return await self.ServicesDeriv.init()
    
    def get_id_methodology(self):
        return self.ServicesMethodologyTrendsExpansiveRecentML.get_id()
    ...
    # --- Métodos de análisis de velas ---
    async def get_candles(self):
        return await self.ServicesDeriv.get_candles()
    
    def check_candles(self,candles):
        return self.ServicesMethodologyTrendsExpansiveRecentML.check_candles(candles)
    ...
    def check_rsi(self,rsi):
        return self.ServicesMethodologyTrendsExpansiveRecentML.check_rsi(rsi)

    def check_sma(self,sma,last_candle):
        return self.ServicesMethodologyTrendsExpansiveRecentML.check_sma(sma,last_candle)
    ...
    def add_result_indicators(self,result_indicators):
        return self.ServicesMethodologyTrendsExpansiveRecentML.add_indicator(result_indicators)  

    def check_result_indicators(self,result_indicators):
        return self.ServicesMethodologyTrendsExpansiveRecentML.check_result_indicators(result_indicators)
    ...
    # --- Métodos de filtros monetarios ---
    def check_monetary_filter_services(self,result):
        return self.ServicesMethodologyTrendsExpansiveRecentML.check_monetary_filters(result)
    ...
    # --- Métodos ML para verificación de modelos predictivos ---
    ...
    # --- Métodos de entrada al broker ---
    def get_money(self):
        return self.ServicesManagerDays.get_money()
    
    def get_type_entry(self):
        return self.ServicesMethodologyTrendsExpansiveRecentML.get_type_entry_positions()
    ...
    # --- Métodos de persistencia y posiciones ---
    ...
    def set_candles_positions(self,candles):
        return self.ServicesMethodologyTrendsExpansiveRecentML.set_result_candles(candles)
    ...
    def get_candle_removed(self):
        return self.ServicesMethodologyTrendsExpansiveRecentML.get_candle_removed()
    ...
    def get_condition_entry(self):
        return self.ServicesMethodologyTrendsExpansiveRecentML.get_condition_entry()
    ...
    def set_result_positions_entity(self,result):
        return self.ServicesMethodologyTrendsExpansiveRecentML.set_result_entrys(result)

    def add_entrys(self,result):
        return self.ServicesEntrys.add_entrys(result)
    
    def get_indicators(self):
        return self.ServicesMethodologyTrendsExpansiveRecentML.get_indicators()
    ...
    def get_result_entrys_result(self):
        return self.ServicesMethodologyTrendsExpansiveRecentML.get_result_entrys_result()

    # --- Métodos ML para persistencia de modelos predictivos ---
