import apis.entities.methodologytrendsminusrecent.EntityMethodologyTrendsMinusRecent as EntityMethodologyTrendsMinusRecent

class ServicesMethodologyTrendsMinusRecent():

    entity = None

    def __init__(self):

        self.entity = EntityMethodologyTrendsMinusRecent.EntityMethodologyTrendsMinusRecent()
