...
class ServicesCheckWMARecent:
    def get_project_name(self):
        return self.ServicesMethodologyWMARecent.get_project_name()
    ...
    def init_services_methodology_wma_recent(self,value):

        self.ServicesMethodologyWMARecent = value
    ...
    def get_id_methodology(self):
        ...
        return self.ServicesMethodologyWMARecent.get_id()
    ...
    def generate_candles(self,candles):
        ...
        return self.ServicesMethodologyWMARecent.generate_candles(candles)
    ...
    def set_indicators_methodology(self,indicators):
        ...
        return self.ServicesMethodologyWMARecent.set_indicators(indicators)
    ...
    def check_candles(self,result):
        ...
        return self.ServicesMethodologyWMARecent.check_candles()
    
    def get_indicators_methodology(self):

        return self.ServicesMethodologyWMARecent.get_indicators()

    def check_rsi(self,rsi):

        return self.ServicesMethodologyWMARecent.check_rsi(rsi)

    def check_sma(self,sma,last_candle):

        return self.ServicesMethodologyWMARecent.check_sma(sma,last_candle)
    ...
    def check_result_indicators(self,result_indicators):
        ...
        return self.ServicesMethodologyWMARecent.check_result_indicators(result_indicators)
    ...
    def check_monetary_filter_services(self,result):
        ...
        return self.ServicesMethodologyWMARecent.check_monetary_filters(result)
    ...
    def get_type_entry(self):
        ...
        return self.ServicesMethodologyWMARecent.get_type_entry_positions()
    ...
    def get_candle_removed(self):
        ...
        return self.ServicesMethodologyWMARecent.get_candle_removed()
    ...
    def get_condition_entry(self):
        ...
        return self.ServicesMethodologyWMARecent.get_condition_entry()
    ...
    def set_result_positions_entity(self,result):
        ...
        return self.ServicesMethodologyWMARecent.set_result_entrys(result)
    
    def set_candles_positions(self,candles):

        return self.ServicesMethodologyWMARecent.set_result_candles(candles)
    ...
    def get_result_entrys_result(self):
        ...
        return self.ServicesMethodologyWMARecent.get_result_entrys_result()
