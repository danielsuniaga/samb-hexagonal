...
class ServicesCkeckTrendsML():
    ...
    def get_project_name(self):
        return self.ServicesMethodologyTrendsML.get_project_name()

    def get_name_methodology(self):
        return self.ServicesMethodologyTrendsML.get_name()
    ...
    def init_services_methodology_trends_ml(self,value):

        self.ServicesMethodologyTrendsML = value
    ...
    def check_candles(self,candles):
        ...
        return self.ServicesMethodologyTrendsML.check_candles(candles)
    ...
    def check_rsi(self,rsi):
        ...
        return self.ServicesMethodologyTrendsML.check_rsi(rsi)
    ...
    def check_sma(self,sma,last_candle):
        ...
        return self.ServicesMethodologyTrendsML.check_sma(sma,last_candle)
    ...
    def check_result_indicators(self,result_indicators):
        ...
        return self.ServicesMethodologyTrendsML.check_result_indicators(result_indicators)
    ...
    def check_monetary_filter_services(self,result):
        ...
        return self.ServicesMethodologyTrendsML.check_monetary_filters(result)
    ...
    def get_type_entry(self):
        ...
        return self.ServicesMethodologyTrendsML.get_type_entry_positions()
    ...
    def set_result_positions_entity(self,result):
        ...
        return self.ServicesMethodologyTrendsML.set_result_entrys(result)

    def set_candles_positions(self,candles):

        return self.ServicesMethodologyTrendsML.set_result_candles(candles)
    ...
    def get_candle_removed(self):
        ...
        return self.ServicesMethodologyTrendsML.get_candle_removed()
    ...
    def get_condition_entry(self):
        ...
        return self.ServicesMethodologyTrendsML.get_condition_entry()
    ...
    def get_id_methodology(self):
        ...
        return self.ServicesMethodologyTrendsML.get_id()
    ...
    def check_models(self):
        ...
        result = self.ServicesModels.check_models()
