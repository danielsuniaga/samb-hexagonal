import apis.entities.methodologywmarecent.EntityMethodologyWMARecent as EntityMethodologyWMARecent

class ServicesMethodologyWMARecent:
    ...
    def __init__(self):
        ...
        self.entity = EntityMethodologyWMARecent.EntityMethodologyWMARecent()
