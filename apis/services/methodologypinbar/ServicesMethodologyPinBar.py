import apis.entities.methodologypinbar.EntityMethodologyPinBar as EntityMethodologyPinBar

class ServicesMethodologyPinBar():

    entity = None

    def __init__(self):

        self.entity = EntityMethodologyPinBar.EntityMethodologyPinBar()
