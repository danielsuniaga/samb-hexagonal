...
class ServicesCheckWMAML:
    def get_project_name(self):
        return self.ServicesMethodologyWMAML.get_project_name()
    # --- Servicios base de WMA ---
    ServicesDeriv = None
    ...
    def init_services_manager_days(self,value):
        ...
        return True
    def init_services_methodology_wma_ml(self,value):
        self.ServicesMethodologyWMAML = value
        return True
    ...
    def get_id_methodology(self):
        return self.ServicesMethodologyWMAML.get_id()
    ...
    def generate_candles(self,candles):
        return self.ServicesMethodologyWMAML.generate_candles(candles)
    ...
    def set_indicators_methodology(self,indicators):
        return self.ServicesMethodologyWMAML.set_indicators(indicators)
    ...
    def check_candles(self,result):
        if not result:
            return False
        return self.ServicesMethodologyWMAML.check_candles()
    def get_indicators_methodology(self):
        return self.ServicesMethodologyWMAML.get_indicators()
    def check_rsi(self,rsi):
        return self.ServicesMethodologyWMAML.check_rsi(rsi)
    def check_sma(self,sma,last_candle):
        return self.ServicesMethodologyWMAML.check_sma(sma,last_candle)
    ...
    def check_result_indicators(self,result_indicators):
        return self.ServicesMethodologyWMAML.check_result_indicators(result_indicators)
    ...
    def check_monetary_filter_services(self,result):
        return self.ServicesMethodologyWMAML.check_monetary_filters(result)
    ...
    def get_type_entry(self):
        return self.ServicesMethodologyWMAML.get_type_entry_positions()
    ...
    def set_candles_positions(self,candles):
        return self.ServicesMethodologyWMAML.set_result_candles(candles)
    ...
    def get_candle_removed(self):
        return self.ServicesMethodologyWMAML.get_candle_removed()
    ...
    def get_condition_entry(self):
        return self.ServicesMethodologyWMAML.get_condition_entry()
    ...
    def set_result_positions_entity(self,result):
        return self.ServicesMethodologyWMAML.set_result_entrys(result)
    ...
    def get_result_entrys_result(self):
        return self.ServicesMethodologyWMAML.get_result_entrys_result()
    ...
    def get_name_methodology(self):
        return self.ServicesMethodologyWMAML.get_name()
