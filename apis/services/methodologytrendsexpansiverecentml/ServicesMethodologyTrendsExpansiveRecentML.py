import apis.entities.methodologytrendsexpansiverecentml.EntityMethodologyTrendsExpansiveRecentML as EntityMethodologyTrendsExpansiveRecentML

class ServicesMethodologyTrendsExpansiveRecentML:

    entity = None

    def __init__(self):
        self.entity = EntityMethodologyTrendsExpansiveRecentML.EntityMethodologyTrendsExpansiveRecentML()
        self.entity.init_config()

    def get_project_name(self):
        return self.entity.get_project_name()

    # --- Métodos base heredados de ServicesMethodologyTrendsExpansiveRecent ---
    def get_id(self):
    ...
    # --- Métodos ML adicionales heredados de ServicesMethodologyPinBarML ---
