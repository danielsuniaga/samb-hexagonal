import apis.entities.methodologytrendsminusrecentml.EntityMethodologyTrendsMinusRecentML as EntityMethodologyTrendsMinusRecentML

class ServicesMethodologyTrendsMinusRecentML:

    entity = None

    def __init__(self):
        self.entity = EntityMethodologyTrendsMinusRecentML.EntityMethodologyTrendsMinusRecentML()
        self.entity.init_config()

    def get_project_name(self):
        return self.entity.get_project_name()

    # --- Métodos base de ServicesMethodologyTrendsMinusRecent ---
    def get_id(self):
