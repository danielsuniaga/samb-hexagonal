...
class ServicesCheckTrendsMinusRecent():
    ...
    def get_project_name(self):
        ...
        return self.ServicesMethodologyTrendsMinusRecent.get_project_name()

    def get_name_methodology(self):

        return self.ServicesMethodologyTrendsMinusRecent.get_name()
    ...
    def init_services_methodology_trends_minus_recent(self,value):

        self.ServicesMethodologyTrendsMinusRecent = value
    ...
    def get_id_methodology(self):
        ...
        return self.ServicesMethodologyTrendsMinusRecent.get_id()
    ...
    def check_candles(self,candles):
        ...
        return self.ServicesMethodologyTrendsMinusRecent.check_candles(candles)
    ...
    def check_rsi(self,rsi):
        ...
        return self.ServicesMethodologyTrendsMinusRecent.check_rsi(rsi)

    def check_sma(self,sma,last_candle):

        return self.ServicesMethodologyTrendsMinusRecent.check_sma(sma,last_candle)
    ...
    def add_result_indicators(self,result_indicators):
        ...
        return self.ServicesMethodologyTrendsMinusRecent.add_indicator(result_indicators)  

    def check_result_indicators(self,result_indicators):

        return self.ServicesMethodologyTrendsMinusRecent.check_result_indicators(result_indicators)
    ...
    def check_monetary_filter_services(self,result):
        ...
        return self.ServicesMethodologyTrendsMinusRecent.check_monetary_filters(result)
    ...
    def get_type_entry(self):
        ...
        return self.ServicesMethodologyTrendsMinusRecent.get_type_entry_positions()
    ...
    def set_candles_positions(self,candles):
        ...
        return self.ServicesMethodologyTrendsMinusRecent.set_result_candles(candles)
    ...
    def get_candle_removed(self):
        ...
        return self.ServicesMethodologyTrendsMinusRecent.get_candle_removed()
    ...
    def get_condition_entry(self):
        ...
        return self.ServicesMethodologyTrendsMinusRecent.get_condition_entry()
    ...
    def set_result_positions_entity(self,result):
        ...
        return self.ServicesMethodologyTrendsMinusRecent.set_result_entrys(result)
    ...
    def get_indicators(self):
        ...
        return self.ServicesMethodologyTrendsMinusRecent.get_indicators()
    ...
    def get_result_entrys_result(self):
        ...
        return self.ServicesMethodologyTrendsMinusRecent.get_result_entrys_result()
