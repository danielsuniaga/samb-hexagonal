import apis.entities.methodologytrendsrecentml.EntityMethodologyTrendsRecentML as EntityMethodologyTrendsRecentML

class ServicesMethodologyTrendsRecentML:
