import apis.entities.methodologytrendsrecent.EntityMethodologyTrendsRecent as EntityMethodologyTrendsRecent

class ServicesMethodologyTrendsRecent():

    entity = None

    def __init__(self):

        self.entity = EntityMethodologyTrendsRecent.EntityMethodologyTrendsRecent()
