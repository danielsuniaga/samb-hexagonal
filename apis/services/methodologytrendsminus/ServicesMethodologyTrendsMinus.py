import apis.entities.methodologytrendsminus.EntityMethodologyTrendsMinus as EntityMethodologyTrendsMinus

class ServicesMethodologyTrendsMinus():

    entity = None

    def __init__(self):

        self.entity = EntityMethodologyTrendsMinus.EntityMethodologyTrendsMinus()
