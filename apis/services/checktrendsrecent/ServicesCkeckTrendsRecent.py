...
class ServicesCkeckTrendsRecent():
    ...
    ServicesMethodologyTrendsRecent = None
    ...
    def get_project_name(self):
        return self.ServicesMethodologyTrendsRecent.get_project_name()

    def get_name_methodology(self):
        return self.ServicesMethodologyTrendsRecent.get_name()
    ...
    def init_services_methodology_trends_recent(self,value):

        self.ServicesMethodologyTrendsRecent = value
    ...
    def check_candles(self,candles):
        ...
        return self.ServicesMethodologyTrendsRecent.check_candles(candles)
    ...
    def check_rsi(self,rsi):
        ...
        return self.ServicesMethodologyTrendsRecent.check_rsi(rsi)
    ...
    def check_sma(self,sma,last_candle):
        ...
        return self.ServicesMethodologyTrendsRecent.check_sma(sma,last_candle)
    ...
    def check_result_indicators(self,result_indicators):
        ...
        return self.ServicesMethodologyTrendsRecent.check_result_indicators(result_indicators)
    
    def add_result_indicators(self,result_indicators):

        return self.ServicesMethodologyTrendsRecent.add_indicator(result_indicators)
    ...
    def check_monetary_filter_services(self,result):
        ...
        return self.ServicesMethodologyTrendsRecent.check_monetary_filters(result)
    ...
    def get_type_entry(self):
        ...
        return self.ServicesMethodologyTrendsRecent.get_type_entry_positions()
    ...
    def set_result_positions_entity(self,result):
        ...
        return self.ServicesMethodologyTrendsRecent.set_result_entrys(result)
    
    def set_candles_positions(self,candles):

        return self.ServicesMethodologyTrendsRecent.set_result_candles(candles)
    ...
    def get_candle_removed(self):
        ...
        return self.ServicesMethodologyTrendsRecent.get_candle_removed()
    ...
    def get_condition_entry(self):
        ...
        return self.ServicesMethodologyTrendsRecent.get_condition_entry()
    ...
    def get_id_methodology(self):
        ...
        return self.ServicesMethodologyTrendsRecent.get_id()
    ...
    def get_indicators(self):
        ...
        return self.ServicesMethodologyTrendsRecent.get_indicators()
    ...
    def get_result_entrys_result(self):
        ...
        return self.ServicesMethodologyTrendsRecent.get_result_entrys_result()
