...
class ServicesCheckTrendsMinusML:
    # --- Servicios base de CheckTrendsMinus ---
    ServicesDeriv = None
    ...
    # --- Métodos de inicialización de servicios ---
    ...
    def init_services_manager_days(self,value):
        ...
        return True
    def init_services_methodology_trends_minus_ml(self,value):
        self.ServicesMethodologyTrendsMinusML = value
        return True
    ...
    def get_id_methodology(self):
        return self.ServicesMethodologyTrendsMinusML.get_id()
    ...
    def check_candles(self,candles):
        return self.ServicesMethodologyTrendsMinusML.check_candles(candles)
    ...
    def check_rsi(self,rsi):
        return self.ServicesMethodologyTrendsMinusML.check_rsi(rsi)
    def check_sma(self,sma,last_candle):
        return self.ServicesMethodologyTrendsMinusML.check_sma(sma,last_candle)
    ...
    def add_result_indicators(self,result_indicators):
        return self.ServicesMethodologyTrendsMinusML.add_indicator(result_indicators)  
    def check_result_indicators(self,result_indicators):
        return self.ServicesMethodologyTrendsMinusML.check_result_indicators(result_indicators)  
    ...
    def check_monetary_filter_services(self,result):
        return self.ServicesMethodologyTrendsMinusML.check_monetary_filters(result)
    ...
    def get_type_entry(self):
        return self.ServicesMethodologyTrendsMinusML.get_type_entry_positions()
    ...
    def set_candles_positions(self,candles):
        return self.ServicesMethodologyTrendsMinusML.set_result_candles(candles)
    ...
    def get_candle_removed(self):
        return self.ServicesMethodologyTrendsMinusML.get_candle_removed()
    ...
    def get_condition_entry(self):
        return self.ServicesMethodologyTrendsMinusML.get_condition_entry()
    ...
    def set_result_positions_entity(self,result):
        return self.ServicesMethodologyTrendsMinusML.set_result_entrys(result)
    def add_entrys(self,result):
        return self.ServicesEntrys.add_entrys(result)
    def get_indicators(self):
        return self.ServicesMethodologyTrendsMinusML.get_indicators()
    ...
    def get_result_entrys_result(self):
        return self.ServicesMethodologyTrendsMinusML.get_result_entrys_result()
    ...
    def get_name_methodology(self):
        return self.ServicesMethodologyTrendsMinusML.get_name()
    ...
    def get_project_name(self):
        return self.ServicesMethodologyTrendsMinusML.get_project_name()
    async def loops(self):

        logger = logging.getLogger('apis.services.checktrendsminusml')
