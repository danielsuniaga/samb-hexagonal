...
class ServicesCheckTrendsMinusRecentML:
    ...
    def init_services_methodology_trends_minus_recent_ml(self,value):
        self.ServicesMethodologyTrendsMinusRecentML = value
        return True
    ...
    def get_id_methodology(self):
        return self.ServicesMethodologyTrendsMinusRecentML.get_id()
    ...
    def check_candles(self,candles):
        return self.ServicesMethodologyTrendsMinusRecentML.check_candles(candles)
    ...
    def check_rsi(self,rsi):
        return self.ServicesMethodologyTrendsMinusRecentML.check_rsi(rsi)

    def check_sma(self,sma,last_candle):
        return self.ServicesMethodologyTrendsMinusRecentML.check_sma(sma,last_candle)
    ...
    def add_result_indicators(self,result_indicators):
        return self.ServicesMethodologyTrendsMinusRecentML.add_indicator(result_indicators)  

    def check_result_indicators(self,result_indicators):
        return self.ServicesMethodologyTrendsMinusRecentML.check_result_indicators(result_indicators)
    ...
    def check_monetary_filter_services(self,result):
        return self.ServicesMethodologyTrendsMinusRecentML.check_monetary_filters(result)
    ...
    def get_type_entry(self):
        return self.ServicesMethodologyTrendsMinusRecentML.get_type_entry_positions()
    ...
    def set_candles_positions(self,candles):
        return self.ServicesMethodologyTrendsMinusRecentML.set_result_candles(candles)
    ...
    def get_candle_removed(self):
        return self.ServicesMethodologyTrendsMinusRecentML.get_candle_removed()
    ...
    def get_condition_entry(self):
        return self.ServicesMethodologyTrendsMinusRecentML.get_condition_entry()
    ...
    def set_result_positions_entity(self,result):
        return self.ServicesMethodologyTrendsMinusRecentML.set_result_entrys(result)

    def add_entrys(self,result):
        return self.ServicesEntrys.add_entrys(result)
    
    def get_indicators(self):
        return self.ServicesMethodologyTrendsMinusRecentML.get_indicators()
    ...
    def get_result_entrys_result(self):
        return self.ServicesMethodologyTrendsMinusRecentML.get_result_entrys_result()
