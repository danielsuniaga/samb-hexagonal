...
class EntityCronjobs():
    ...
    def get_id_api_trends_recent_ml(self):
        ...
        return self.get_id_api_key('trends_recent_ml')
    
    def get_id_api_trends_minus_recent_ml(self):

        return self.get_id_api_key('trends_minus_recent_ml')
    ...
    def get_id_api_trends_expansive_recent_ml(self):
        ...
        return self.get_id_api_key('trends_expansive_recent_ml')
    ...
    def get_id_api_wma_recent_ml(self):
        ...
        return self.get_id_api_key('wma_recent_ml')
