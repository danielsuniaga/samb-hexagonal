...
class EntityApi():
    ...
    def init_apis_ids(self):
        ...
        self.apis_ids = {
            ...
            'trends_minus_recent_ml':config("ID_API_TRENDS_MINUS_RECENT_ML"),
            ...
            'trends_expansive_recent_ml':config("ID_API_TRENDS_EXPANSIVE_RECENT_ML"),
    ...
    def get_apis_name_trends_minus_recent_ml(self):
        ...
        id = self.get_apis_ids('trends_minus_recent_ml')
    ...
    def get_apis_name_wma_recent(self):
        ...
        id = self.get_apis_ids('wma_recent')

        return self.get_apis_name(id)

    def get_apis_name_wma_recent_ml(self):

        id = self.get_apis_ids('wma_recent_ml')
    ...
    def get_apis_name_trends_expansive_recent(self):
        ...
        id = self.get_apis_ids('trends_expansive_recent')

        return self.get_apis_name(id)

    def get_apis_name_trends_expansive_recent_ml(self):

        id = self.get_apis_ids('trends_expansive_recent_ml')
