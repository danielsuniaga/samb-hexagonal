...
import apis.services.checktrendsminusml.ServicesCheckTrendsMinusML as ServicesCheckTrendsMinusML
import apis.services.managerdays.ServicesManagerDays as ServicesManagerDays
import apis.services.methodologytrendsminusml.ServicesMethodologyTrendsMinusML as ServicesMethodologyTrendsMinusML
...
class ControllerGetDataAnalysisDerivTrendsMinusML:
    ...
    ServicesCheckTrendsMinusML = None
    ServicesManagerDays = None
    ServicesMethodologyTrendsMinusML = None
    ...
    def initialize_services(self):
        ...
        self.ServicesCheckTrendsMinusML = ServicesCheckTrendsMinusML.ServicesCheckTrendsMinusML()
        self.ServicesManagerDays = ServicesManagerDays.ServicesManagerDays()
        self.ServicesMethodologyTrendsMinusML = ServicesMethodologyTrendsMinusML.ServicesMethodologyTrendsMinusML()
    ...
    def initialize_check_trends_services_interns(self):
        ...
        self.ServicesCheckTrendsMinusML.init_services_manager_days(self.ServicesManagerDays)
        self.ServicesCheckTrendsMinusML.init_services_methodology_trends_minus_ml(self.ServicesMethodologyTrendsMinusML)
        self.ServicesCheckTrendsMinusML.init_services_indicators(self.ServicesIndicators)
        self.ServicesCheckTrendsMinusML.init_services_entrys_results(self.ServicesEntrysResults)
        self.ServicesCheckTrendsMinusML.init_services_entrys(self.ServicesEntrys)
        self.ServicesCheckTrendsMinusML.init_services_cronjobs(self.ServicesCronjobs)
        self.ServicesCheckTrendsMinusML.init_services_platform(self.ServicesPlatform)
        self.ServicesCheckTrendsMinusML.init_services_indicators_entrys(self.ServicesIndicatorsEntrys)
        self.ServicesCheckTrendsMinusML.init_services_movements(self.ServicesMovements)
        self.ServicesCheckTrendsMinusML.init_services_telegram(self.ServicesTelegram)
        self.ServicesCheckTrendsMinusML.init_services_deriv(self.ServicesDeriv)
        self.ServicesCheckTrendsMinusML.init_services_models(self.ServicesModels)
    ...
    def init_verify_services(self, hour, date, id_cronjobs):
        return [
            ...
            },
            {
                ...
                'function': lambda: self.ServicesCronjobs.add_trends_minus_ml(id_cronjobs, date),
                'send_email_on_error': True
            },
            {
                'name': 'models_service',
    ...
    async def GetDataAnalysisDerivMinusML(self, request):
    ...
    async def process_deriv_services(self):
        await self.ServicesCheckTrendsMinusML.loops()
        await self.ServicesCheckTrendsMinusML.closed()
    ...
    async def initialize_deriv_services(self, date):
        ...
        result = await self.ServicesCheckTrendsMinusML.init()
        if not result['status']:
            return result
        self.ServicesEvents.set_events_field('init_broker', self.ServicesDates.get_current_date_mil_dynamic())
        await self.ServicesCheckTrendsMinusML.set_balance(self.ServicesDates.get_day())
        self.ServicesEvents.set_events_field('config_broker', self.ServicesDates.get_current_date_mil_dynamic())
        self.ServicesCheckTrendsMinusML.init_services_events(self.ServicesEvents)
        self.ServicesCheckTrendsMinusML.init_services_dates(self.ServicesDates)
