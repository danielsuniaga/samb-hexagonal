...
import apis.services.checkpinbarml.ServicesCheckPinBarML as ServicesCheckPinBarML
import apis.services.deriv.ServicesDeriv as ServicesDeriv
import apis.services.methodologypinbarml.ServicesMethodologyPinBarML as ServicesMethodologyPinBarML
...
class ControllerGetDataAnalysisDerivPinBarML:
    ...
    ServicesApi = None
    ServicesSmtp = None
    ServicesCheckPinBarML = None
    ServicesDeriv = None
    ServicesMethodologyPinBarML = None
    ...
    def __init__(self):
        ...
        self.initialize_check_pinbar_services_interns()
    ...
    def initialize_services(self):
        ...
        self.ServicesCheckPinBarML = ServicesCheckPinBarML.ServicesCheckPinBarML()
        self.ServicesDeriv = ServicesDeriv.ServicesDeriv()
        self.ServicesMethodologyPinBarML = ServicesMethodologyPinBarML.ServicesMethodologyPinBarML()
    ...
    def initialize_check_pinbar_services_interns(self):
        ...
        self.ServicesCheckPinBarML.init_services_deriv(self.ServicesDeriv)
        self.ServicesCheckPinBarML.init_services_methodology_pinbar_ml(self.ServicesMethodologyPinBarML)
        self.ServicesCheckPinBarML.init_services_manager_days(self.ServicesManagerDays)
        self.ServicesCheckPinBarML.init_services_indicators(self.ServicesIndicators)
        self.ServicesCheckPinBarML.init_services_entrys_results(self.ServicesEntrysResults)
        self.ServicesCheckPinBarML.init_services_movements(self.ServicesMovements)
        self.ServicesCheckPinBarML.init_services_platform(self.ServicesPlatform)
        self.ServicesCheckPinBarML.init_services_entrys(self.ServicesEntrys)
        self.ServicesCheckPinBarML.init_services_indicators_entrys(self.ServicesIndicatorsEntrys)    
        self.ServicesCheckPinBarML.init_services_cronjobs(self.ServicesCronjobs)
        self.ServicesCheckPinBarML.init_services_telegram(self.ServicesTelegram)
        self.ServicesCheckPinBarML.init_services_models(self.ServicesModels)
        self.ServicesCheckPinBarML.init_services_methodologys(self.ServicesMethodologys)
        self.ServicesCheckPinBarML.init_services_entrys_predict_models(self.ServicesEntrysPredictModels)

    def get_apis_name_pinbar_ml(self):
        return self.ServicesApi.get_apis_name_pinbar_ml()

    def set_apis_name_smtp(self):
        return self.ServicesSmtp.set_apis_name(self.get_apis_name_pinbar_ml())
    ...
    def init_verify_services(self, hour, date, id_cronjobs):
        return [
            ...
            },
            {
                ...
                'function': lambda: self.ServicesCronjobs.add_pinbar_ml(id_cronjobs, date),
                'send_email_on_error': True
            },
            {
                'name': 'models_service',
    ...
    async def initialize_deriv_services(self, date):
        ...
        result = await self.ServicesCheckPinBarML.init()
        if not result['status']:
            return result
        self.ServicesEvents.set_events_field('init_broker', self.ServicesDates.get_current_date_mil_dynamic())
        await self.ServicesCheckPinBarML.set_balance(self.ServicesDates.get_day())
        self.ServicesEvents.set_events_field('config_broker', self.ServicesDates.get_current_date_mil_dynamic())
        self.ServicesCheckPinBarML.init_services_events(self.ServicesEvents)
        self.ServicesCheckPinBarML.init_services_dates(self.ServicesDates)
        return {'status': True, 'message': 'Initialization successful'}
    
    async def process_deriv_services(self):
        await self.ServicesCheckPinBarML.loops()
        await self.ServicesCheckPinBarML.closed()
    ...
    async def GetDataAnalysisDerivPinBarML(self, request):
