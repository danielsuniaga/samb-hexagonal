...
import apis.services.checktrendsminusrecentml.ServicesCheckTrendsMinusRecentML as ServicesCheckTrendsMinusRecentML
import apis.services.deriv.ServicesDeriv as ServicesDeriv
import apis.services.methodologytrendsminusrecentml.ServicesMethodologyTrendsMinusRecentML as ServicesMethodologyTrendsMinusRecentML
...
class ControllerGetDataAnalysisDerivTrendsMinusRecentML:
    ...
    ServicesApi = None
    ServicesSmtp = None
    ServicesCheckTrendsMinusRecentML = None
    ServicesDeriv = None
    ServicesMethodologyTrendsMinusRecentML = None
    ...
    def __init__(self):
        ...
        self.initialize_check_trends_minus_recent_services_interns()
    ...
    def initialize_services(self):
        ...
        self.ServicesCheckTrendsMinusRecentML = ServicesCheckTrendsMinusRecentML.ServicesCheckTrendsMinusRecentML()
        self.ServicesDeriv = ServicesDeriv.ServicesDeriv()
        self.ServicesMethodologyTrendsMinusRecentML = ServicesMethodologyTrendsMinusRecentML.ServicesMethodologyTrendsMinusRecentML()
    ...
    def initialize_check_trends_minus_recent_services_interns(self):
        ...
        self.ServicesCheckTrendsMinusRecentML.init_services_deriv(self.ServicesDeriv)
        self.ServicesCheckTrendsMinusRecentML.init_services_methodology_trends_minus_recent_ml(self.ServicesMethodologyTrendsMinusRecentML)
        self.ServicesCheckTrendsMinusRecentML.init_services_manager_days(self.ServicesManagerDays)
        self.ServicesCheckTrendsMinusRecentML.init_services_indicators(self.ServicesIndicators)
        self.ServicesCheckTrendsMinusRecentML.init_services_entrys_results(self.ServicesEntrysResults)
        self.ServicesCheckTrendsMinusRecentML.init_services_movements(self.ServicesMovements)
        self.ServicesCheckTrendsMinusRecentML.init_services_platform(self.ServicesPlatform)
        self.ServicesCheckTrendsMinusRecentML.init_services_entrys(self.ServicesEntrys)
        self.ServicesCheckTrendsMinusRecentML.init_services_indicators_entrys(self.ServicesIndicatorsEntrys)    
        self.ServicesCheckTrendsMinusRecentML.init_services_cronjobs(self.ServicesCronjobs)
        self.ServicesCheckTrendsMinusRecentML.init_services_telegram(self.ServicesTelegram)
        self.ServicesCheckTrendsMinusRecentML.init_services_models(self.ServicesModels)
        self.ServicesCheckTrendsMinusRecentML.init_services_methodologys(self.ServicesMethodologys)
        self.ServicesCheckTrendsMinusRecentML.init_services_entrys_predict_models(self.ServicesEntrysPredictModels)

    def get_apis_name_trends_minus_recent_ml(self):
        return self.ServicesApi.get_apis_name_trends_minus_recent_ml()

    def set_apis_name_smtp(self):
        return self.ServicesSmtp.set_apis_name(self.get_apis_name_trends_minus_recent_ml())
    ...
    def init_verify_services(self, hour, date, id_cronjobs):
        return [
            ...
            },
            {
                ...
                'function': lambda: self.ServicesCronjobs.add_trends_minus_recent_ml(id_cronjobs, date),
                'send_email_on_error': True
            },
            {
                'name': 'models_service',
    ...
    async def initialize_deriv_services(self, date):
        ...
        result = await self.ServicesCheckTrendsMinusRecentML.init()
        if not result['status']:
            return result
        self.ServicesEvents.set_events_field('init_broker', self.ServicesDates.get_current_date_mil_dynamic())
        await self.ServicesCheckTrendsMinusRecentML.set_balance(self.ServicesDates.get_day())
        self.ServicesEvents.set_events_field('config_broker', self.ServicesDates.get_current_date_mil_dynamic())
        self.ServicesCheckTrendsMinusRecentML.init_services_events(self.ServicesEvents)
        self.ServicesCheckTrendsMinusRecentML.init_services_dates(self.ServicesDates)
        return {'status': True, 'message': 'Initialization successful'}
    
    async def process_deriv_services(self):
        await self.ServicesCheckTrendsMinusRecentML.loops()
        await self.ServicesCheckTrendsMinusRecentML.closed()
    ...
    async def GetDataAnalysisDerivTrendsMinusRecentML(self, request):
