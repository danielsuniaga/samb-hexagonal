...
import apis.services.checktrendsrecentml.ServicesCheckTrendsRecentML as ServicesCheckTrendsRecentML
import apis.services.deriv.ServicesDeriv as ServicesDeriv
import apis.services.methodologytrendsrecentml.ServicesMethodologyTrendsRecentML as ServicesMethodologyTrendsRecentML
...
class ControllerGetDataAnalysisDerivTrendsRecentML:
    ...
    ServicesApi = None
    ServicesSmtp = None
    ServicesCheckTrendsRecentML = None
    ServicesDeriv = None
    ServicesMethodologyTrendsRecentML = None
    ...
    def __init__(self):
        ...
        self.initialize_check_trends_recent_services_interns()
    ...
    def initialize_services(self):
        ...
        self.ServicesCheckTrendsRecentML = ServicesCheckTrendsRecentML.ServicesCheckTrendsRecentML()
        self.ServicesDeriv = ServicesDeriv.ServicesDeriv()
        self.ServicesMethodologyTrendsRecentML = ServicesMethodologyTrendsRecentML.ServicesMethodologyTrendsRecentML()
    ...
    def initialize_check_trends_recent_services_interns(self):
        ...
        self.ServicesCheckTrendsRecentML.init_services_deriv(self.ServicesDeriv)
        self.ServicesCheckTrendsRecentML.init_services_methodology_trends_recent_ml(self.ServicesMethodologyTrendsRecentML)
        self.ServicesCheckTrendsRecentML.init_services_manager_days(self.ServicesManagerDays)
        self.ServicesCheckTrendsRecentML.init_services_indicators(self.ServicesIndicators)
        self.ServicesCheckTrendsRecentML.init_services_entrys_results(self.ServicesEntrysResults)
        self.ServicesCheckTrendsRecentML.init_services_movements(self.ServicesMovements)
        self.ServicesCheckTrendsRecentML.init_services_platform(self.ServicesPlatform)
        self.ServicesCheckTrendsRecentML.init_services_entrys(self.ServicesEntrys)
        self.ServicesCheckTrendsRecentML.init_services_indicators_entrys(self.ServicesIndicatorsEntrys)    
        self.ServicesCheckTrendsRecentML.init_services_cronjobs(self.ServicesCronjobs)
        self.ServicesCheckTrendsRecentML.init_services_telegram(self.ServicesTelegram)
        self.ServicesCheckTrendsRecentML.init_services_models(self.ServicesModels)
        self.ServicesCheckTrendsRecentML.init_services_methodologys(self.ServicesMethodologys)
        self.ServicesCheckTrendsRecentML.init_services_entrys_predict_models(self.ServicesEntrysPredictModels)

    def get_apis_name_trends_recent_ml(self):
        return self.ServicesApi.get_apis_name_trends_recent_ml()

    def set_apis_name_smtp(self):
        return self.ServicesSmtp.set_apis_name(self.get_apis_name_trends_recent_ml())
    ...
    def init_verify_services(self, hour, date, id_cronjobs):
        return [
            ...
            },
            {
                ...
                'function': lambda: self.ServicesCronjobs.add_trends_recent_ml(id_cronjobs, date),
                'send_email_on_error': True
            },
            {
                'name': 'models_service',
    ...
    async def initialize_deriv_services(self, date):
        ...
        result = await self.ServicesCheckTrendsRecentML.init()
        if not result['status']:
            return result
        self.ServicesEvents.set_events_field('init_broker', self.ServicesDates.get_current_date_mil_dynamic())
        await self.ServicesCheckTrendsRecentML.set_balance(self.ServicesDates.get_day())
        self.ServicesEvents.set_events_field('config_broker', self.ServicesDates.get_current_date_mil_dynamic())
        self.ServicesCheckTrendsRecentML.init_services_events(self.ServicesEvents)
        self.ServicesCheckTrendsRecentML.init_services_dates(self.ServicesDates)
        return {'status': True, 'message': 'Initialization successful'}
    
    async def process_deriv_services(self):
        await self.ServicesCheckTrendsRecentML.loops()
        await self.ServicesCheckTrendsRecentML.closed()
    ...
    async def GetDataAnalysisDerivTrendsRecentML(self, request):
