...
import apis.services.checktrendsexpansiverecentml.ServicesCheckTrendsExpansiveRecentML as ServicesCheckTrendsExpansiveRecentML
import apis.services.deriv.ServicesDeriv as ServicesDeriv
import apis.services.methodologytrendsexpansiverecentml.ServicesMethodologyTrendsExpansiveRecentML as ServicesMethodologyTrendsExpansiveRecentML
...
class ControllerGetDataAnalysisDerivTrendsExpansiveRecentML:
    ...
    ServicesApi = None
    ServicesSmtp = None
    ServicesCheckTrendsExpansiveRecentML = None
    ServicesDeriv = None
    ServicesMethodologyTrendsExpansiveRecentML = None
    ...
    def __init__(self):
        ...
        self.initialize_check_trends_expansive_recent_services_interns()
    ...
    def initialize_services(self):
        ...
        self.ServicesCheckTrendsExpansiveRecentML = ServicesCheckTrendsExpansiveRecentML.ServicesCheckTrendsExpansiveRecentML()
        self.ServicesDeriv = ServicesDeriv.ServicesDeriv()
        self.ServicesMethodologyTrendsExpansiveRecentML = ServicesMethodologyTrendsExpansiveRecentML.ServicesMethodologyTrendsExpansiveRecentML()
    ...
    def initialize_check_trends_expansive_recent_services_interns(self):
        ...
        self.ServicesCheckTrendsExpansiveRecentML.init_services_deriv(self.ServicesDeriv)
        self.ServicesCheckTrendsExpansiveRecentML.init_services_methodology_trends_expansive_recent_ml(self.ServicesMethodologyTrendsExpansiveRecentML)
        self.ServicesCheckTrendsExpansiveRecentML.init_services_manager_days(self.ServicesManagerDays)
        self.ServicesCheckTrendsExpansiveRecentML.init_services_indicators(self.ServicesIndicators)
        self.ServicesCheckTrendsExpansiveRecentML.init_services_entrys_results(self.ServicesEntrysResults)
        self.ServicesCheckTrendsExpansiveRecentML.init_services_movements(self.ServicesMovements)
        self.ServicesCheckTrendsExpansiveRecentML.init_services_platform(self.ServicesPlatform)
        self.ServicesCheckTrendsExpansiveRecentML.init_services_entrys(self.ServicesEntrys)
        self.ServicesCheckTrendsExpansiveRecentML.init_services_indicators_entrys(self.ServicesIndicatorsEntrys)    
        self.ServicesCheckTrendsExpansiveRecentML.init_services_cronjobs(self.ServicesCronjobs)
        self.ServicesCheckTrendsExpansiveRecentML.init_services_telegram(self.ServicesTelegram)
        self.ServicesCheckTrendsExpansiveRecentML.init_services_models(self.ServicesModels)
        self.ServicesCheckTrendsExpansiveRecentML.init_services_methodologys(self.ServicesMethodologys)
        self.ServicesCheckTrendsExpansiveRecentML.init_services_entrys_predict_models(self.ServicesEntrysPredictModels)

    def get_apis_name_trends_expansive_recent_ml(self):
        return self.ServicesApi.get_apis_name_trends_expansive_recent_ml()

    def set_apis_name_smtp(self):
        return self.ServicesSmtp.set_apis_name(self.get_apis_name_trends_expansive_recent_ml())
    ...
    def init_verify_services(self, hour, date, id_cronjobs):
        return [
            ...
            },
            {
                ...
                'function': lambda: self.ServicesCronjobs.add_trends_expansive_recent_ml(id_cronjobs, date),
                'send_email_on_error': True
            },
            {
                'name': 'models_service',
    ...
    async def initialize_deriv_services(self, date):
        ...
        result = await self.ServicesCheckTrendsExpansiveRecentML.init()
        if not result['status']:
            return result
        self.ServicesEvents.set_events_field('init_broker', self.ServicesDates.get_current_date_mil_dynamic())
        await self.ServicesCheckTrendsExpansiveRecentML.set_balance(self.ServicesDates.get_day())
        self.ServicesEvents.set_events_field('config_broker', self.ServicesDates.get_current_date_mil_dynamic())
        self.ServicesCheckTrendsExpansiveRecentML.init_services_events(self.ServicesEvents)
        self.ServicesCheckTrendsExpansiveRecentML.init_services_dates(self.ServicesDates)
        return {'status': True, 'message': 'Initialization successful'}
    
    async def process_deriv_services(self):
        await self.ServicesCheckTrendsExpansiveRecentML.loops()
        await self.ServicesCheckTrendsExpansiveRecentML.closed()
    ...
    async def GetDataAnalysisDerivTrendsExpansiveRecentML(self, request):
